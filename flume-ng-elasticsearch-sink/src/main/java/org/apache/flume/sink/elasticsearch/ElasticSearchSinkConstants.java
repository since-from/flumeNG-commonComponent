...
public class ElasticSearchSinkConstants {
  ...
  //es log type exception
  public static final String ES_LOGTYPE_EXCEPTION_KEY = "ExceptionJson";
  //es log type large
  public static final String ES_LOGTYPE_LARGE_KEY = "ExpectStoreDays";
  ...
  public static final String DEFAULT_INDEX_NAME_BUILDER_CLASS =
     ...
     * customise fields
     */
    public final static String INDEX_EXCEPTION_NAME = "InterVacationExLog";
}
